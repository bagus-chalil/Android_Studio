...
public class TampilObat extends AppCompatActivity implements View.OnClickListener{
    ...
    private String id;
    private String kode,nama,satuan,jumlah,harga,kadaluwarsa;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        jumlah = intent.getStringExtra(Konfigurasi.BRG_JUMLAH_OBAT);
    ...
    private void showBarang(String json){
        try {
            ...
            String jumlah = c.getString(Konfigurasi.TAG_JUMLAH_OBAT);
    ...
    private void updateBarang(){
        ...
        class UpdateBarang extends AsyncTask<Void,Void,String>{
            ...
            protected String doInBackground(Void... params) {
                ...
                hashMap.put(Konfigurasi.KEY_EMP_JUMLAH_OBAT,jumlah);
        ...
        alertDialogBuilder.setPositiveButton("Ya",
                new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface arg0, int arg1) {
                        deleteBarang();
                        startActivity(new Intent(TampilObat.this, com.example.uts.TampilSemua_Obat.class));
                    }
                });
