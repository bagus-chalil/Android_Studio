...
public class TambahKHS extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tambah_khs);
    ...
    private void AddBarang(){
        ...
        class AddBarang extends AsyncTask<Void,Void,String>{
            ...
            protected void onPreExecute() {
                super.onPreExecute();
                loading = ProgressDialog.show(TambahKHS.this,"Menambahkan...","Tunggu...",false,false);
            }
            ...
            protected void onPostExecute(String s) {
                ...
                loading.dismiss();
                Toast.makeText(TambahKHS.this,s,Toast.LENGTH_LONG).show();
            }
    ...
    public void onClick(View v) {
        ...
        if(v == buttonView){
            startActivity(new Intent(this,TampilSemua_KHS.class));
        }
    }
