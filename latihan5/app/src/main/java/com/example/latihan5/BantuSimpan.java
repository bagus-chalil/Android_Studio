...
public class BantuSimpan extends AsyncTask<String,Void,Void> {
    Context context;
    public BantuSimpan(Context ct) {
        this.context=ct;
    ...
    protected Void doInBackground(String... params) {
        String urlku="http://192.168.100.73:8085/android/latihan4/simpan_data.php";

        String kode=params[1];
        String nama=params[2];
        String harga=params[3];
        try {
            URL url=new URL(urlku);
